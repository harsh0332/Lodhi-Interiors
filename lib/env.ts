...
function resolveEnv(): EnvConfig {
  try {
    ...
    const fallbackSource: Record<string, string | undefined> = {
      ...
      NEXT_PUBLIC_WHATSAPP_NUMBER: process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '918109392314',
      NEXT_PUBLIC_PHONE_NUMBER: process.env.NEXT_PUBLIC_PHONE_NUMBER || '+91 81093 92314',
