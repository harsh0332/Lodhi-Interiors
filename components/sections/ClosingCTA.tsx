...
export function ClosingCTA() {
  ...
  return (
    <section
      ...
      className="relative w-full border-t border-greige/20 bg-charcoal py-24 text-bone transition-colors md:py-36"
      aria-label="Call to Action"
    >
      <div className="mx-auto w-full max-w-container px-5 md:px-12">
